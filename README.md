...
<p>
  ...
  <img src="./img/01.png" alt="Mostra-se que Arquivo é o primeiro menu da esquerda para a direita, e que NewFromTemplate é a segunda opção">
  ...
  <img src="./img/02.png" alt="Mostra uma janela com uma serie de opções como por ex A4 e Icon, e que a opção desejada se encontra na 13ª posição">
  <i><h6>Janela de opções de template</h6></i><br>
  
  A nova janela aberta deve parecer com essa: <br> <br>
  <img src="./img/03.png" alt="Janela de tipografia, no fundo há uma folha em branco com algumas margens pra auxiliar com o desenho">
...
<p>
  ...
  <img src="./img/28.png" alt="" width=120% height=120% >
