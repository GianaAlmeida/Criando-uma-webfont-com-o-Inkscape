...
<p>
  ...
  Repita a operação quantas vezes desejar.<br>
...
<p>
  ...
  Após centralizar na vertical, agora centralizaremos na horizontal. O Inkscape pegará essas referências na hora de transformas essa imagem em "letra". <br>
  ...
  Agora é o momento de unir o que oi desagrupado. Para isso acesse o menu "Caminho" e selecione a opção "União", ou utilize o atalho de teclado (CTRL + +).<br>
...
<p>
  ...
  Repita esses passos para as próximas imagens. A pilha ficará mais u menos como na imagem abaixo:<br>
